...
<head>
    ...
    <!-- Nucleo Icons -->
    <link href="{{ asset('dashboard_assets/icons/nucleo-icons.css') }}" rel="stylesheet" />
    <link href="{{ asset('dashboard_assets/icons/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- Font Awesome Icons -->
    {{-- <script src="{{ asset('dashboard_assets/icons/42d5adcbca.html') }}" crossorigin="anonymous"></script> --}}
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('dashboard_assets/css/argon-dashboard.minf066.css?v=2.1.0') }}"
        rel="stylesheet" />
    ...
    <script>
        ...
        })(window, document, 'script', "{{ asset('dashboard_assets/js/analytics.js') }}", 'ga');
...
<body class="g-sidenav-show bg-gray-100">
    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="dashboard.html" target="_blank">
                <img src="{{ asset('dashboard_assets/img/logo-ct-dark.png') }}" width="26px" height="26px"
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="https://demos.creative-tim.com/argon-dashboard/assets/img/small-logos/logo-spotify.svg"
                                ...
                                <tbody>
                                    <tr>
                                        <td class="w-30">
                                            <div class="d-flex px-2 py-1 align-items-center">
                                                <div>
                                                    <img src="{{ asset('dashboard_assets/img/icons/flags/US.png') }}"
                                                        alt="Country flag">
                                                </div>
                                                <div class="ms-4">
                                    ...
                                    <tr>
                                        <td class="w-30">
                                            <div class="d-flex px-2 py-1 align-items-center">
                                                <div>
                                                    <img src="{{ asset('dashboard_assets/img/icons/flags/DE.png') }}"
                                                        alt="Country flag">
                                                </div>
                                                <div class="ms-4">
                                                    <p class="text-xs font-weight-bold mb-0">Country:</p>
                                    ...
                                    <tr>
                                        <td class="w-30">
                                            <div class="d-flex px-2 py-1 align-items-center">
                                                <div>
                                                    <img src="{{ asset('dashboard_assets/img/icons/flags/GB.png') }}"
                                                        alt="Country flag">
                                                </div>
                                                <div class="ms-4">
                                                    <p class="text-xs font-weight-bold mb-0">Country:</p>
                                    ...
                                    <tr>
                                        <td class="w-30">
                                            <div class="d-flex px-2 py-1 align-items-center">
                                                <div>
                                                    <img src="{{ asset('dashboard_assets/img/icons/flags/BR.png') }}"
                                                        alt="Country flag">
                                                </div>
                                                <div class="ms-4">
                                                    <p class="text-xs font-weight-bold mb-0">Country:</p>
    ...
    <!-- Github buttons -->
    <script async defer src="{{ asset('dashboard_assets/js/buttons.js') }}buttons.js"></script>
    <!-- Control Center for Soft Dashboard: parallax effects, scripts for the example pages etc -->
    <script src="{{ asset('dashboard_assets/js/argon-dashboard.minf066.js?v=2.1.0') }}"></script>
